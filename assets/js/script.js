 ...
 */
 ...
 let playerScore=0;//this will be incremented on later in the scoring section
 let computerScore=0;//this will be incremented on later in the scoring section
 let answer=``;
